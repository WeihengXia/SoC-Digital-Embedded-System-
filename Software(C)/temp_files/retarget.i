...
FILE __stdout = 	{(unsigned char *)&((UART_t *)0x51000000)->TxData};
FILE __stdin = 		{(unsigned char *)&((UART_t *)0x51000000)->RxData};

int uart_out(int ch)
{
	while((((UART_t *)0x51000000)->Status & (1<<0)))	{
		;	
	}
	((UART_t *)0x51000000)->TxData = (char)ch;
	return(ch);
}
